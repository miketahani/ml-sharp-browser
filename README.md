...
A React app is included which allows a user to convert their own images. It can be viewed online at [here](https://miketahani.com/ml-sharp-browser/). No images are uploaded anywhere and inference happens 100% clientside. The demo is CHROME ONLY for now as WebGPU is not supported in Firefox.